                            ...
                            <tbody>
                                <?php foreach ($alternatives as $alternatif) : ?>
                                    <tr class ="text-center">
                                        ...
                                        <?php endforeach; ?>
                                        <td>
                                            <a class="btn btn-sm btn-danger mb-md-0 mb-1" href="delete.php?alternative_id=<?= $alternatif['id'] ?>" role="button" onclick="return confirm('Apakah Anda yakin akan menghapus data ini?')">
