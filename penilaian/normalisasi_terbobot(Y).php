                                        ...
                                        <?php foreach ($criterias as $kriteria) : ?>
                                            <td>
                                                ...
                                                if ($alternatif_value !== null) {
                                                    ...
                                                    // Multiply normalized value by the weight
                                                    $weightedValue = ($normalizedValue[$alternatif['id']][$kriteria['id']] ?? '-') * $kriteria['weight'];
                                                    echo '<h6>' . number_format($weightedValue, 3) . '</h6>';
                                                } else {
                                                    echo '<h6>-</h6>';
                                                }
                                                ?>
